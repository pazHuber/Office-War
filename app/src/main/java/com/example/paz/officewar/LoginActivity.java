 ...
 * {@link com.example.paz.officewar.TwitterOAuthActivity}
...
public class LoginActivity extends ActionBarActivity implements
    ...
    /* Start game after log in succsied */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStartGameBtn = (Button) findViewById(R.id.start_game);
            ...
            if (name != null) {
                ...
                mStartGameBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("USER_NAME", fName);
